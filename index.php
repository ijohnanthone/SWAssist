...
if ($page === 'case-create' && $_SERVER['REQUEST_METHOD'] === 'POST') {
	...
	if ($clientName === '') { flash('error', 'Client name is required.'); redirect('index.php?page=case-create'); }
	$caseYear = date('Y');
